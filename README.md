...
By default this plugin use org.apache.jasper.compiler.JDTCompiler (see compilerName goal option). But if number of threads is over 2, this compiler have too much synchronization and it's not very performant. To improve this is possible to user another compiler "org.apache.jasper.compiler.ParallelJDTCompiler", who reduce period of synchronization.
